...
<script>
    ...
    function previewCourseDetail() {
        ...
        $.ajax({
            url: '<?=base_url()?>admin/previewCourseDetail',
            method: 'post',
        ...
        // window.open('<?=base_url()?>home/courseDetail/' + globalBranchId, '_blank');
        // window.location = '<?=base_url()?>home/courseDetail?courseDetail=' + courseDetail;
    }
