<link href="<?=asset_url()?>bootstrap-summernote/summernote.css" rel="stylesheet" type="text/css" />
<script src="<?=asset_url()?>bootstrap-summernote/summernote.min.js" type="text/javascript"></script>
<!--
    <div class="row">
        <div class="col-md-12">
            <div id="editor">
...
<?php $this->load->view('admin/courseManagement/faculty'); ?>
<?php $this->load->view('admin/courseManagement/branch'); ?>
<?php $this->load->view('admin/courseManagement/courseEditor'); ?>