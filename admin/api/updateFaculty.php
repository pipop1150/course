...
$sql = "UPDATE faculty SET facultyNameTH = '$facultyNameTH', facultyNameEN = '$facultyNameEN' WHERE facultyId = $facultyId";
...
$result = array(
    'success' => true,
    'message' => 'แก้ไขข้อมูลคณะเป็น: ' . $facultyNameTH . ' สำเร็จ'
);
